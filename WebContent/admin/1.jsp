                                                ...
                                                <div class="p-20">
                                                  ...
                                                  data-parsley-validate novalidate>
													...
													<select id="Area" class="form-control" name="areaID">
                                                      ...
                                                      <div class="form-group">
														<label for="CityName">amb Name<span
															...
															<select id="City" class="form-control" name="ambulanceNumber">

															<f:forEach items="${sessionScope.ablist}" var="p">


																<option value="${p.ambulanceNumber}">${p.ambulanceName}</option>
                                                   ...
                                                   <div class="form-group">
													...
													<div class="form-group">
														<label for="StateName">gender<span
															class="text-danger">*</span></label> <input type="radio"
															name="gender" parsley-trigger="change" required
															placeholder="Enter description" class="form-control">
													</div>
													<div class="form-group">
														<label for="StateName">qualification<span
															class="text-danger">*</span></label> <input type="text"
															name="qualification" parsley-trigger="change" required
															placeholder="Enter description" class="form-control">
													</div>
