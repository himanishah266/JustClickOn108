                            ...
                            <div class="col-sm-12">
								...
								<input type="hidden" name="flag" value="search">
                                    <table id="datatable" class="table table-striped table-bordered">
										...
										<td>${a.gender}</td>
										<td>${a.post}</td>
										<td>${a.statevo.stateName}</td>
										<td>${a.cityvo.cityName}</td>
										<td>${a.areavo.areaName}</td>
										<td>${a.avo.ambulanceNumber}</td>
										
											            
										<td><a href="<%=request.getContextPath()%>/StaffController?flag=edit&serialNo=${a.serialNo}">edit</a> </td>
										<td><a href="<%=request.getContextPath()%>/StaffController?flag=delete&serialNo=${a.serialNo}">/delete</a> </td>
										</tr>
										<tr>
										</tr>
