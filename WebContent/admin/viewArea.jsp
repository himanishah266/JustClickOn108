...
<script>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
         ...
         <td>    <a href="<%=request.getContextPath()%>/AreaController?flag=edit&areaID=${c.areaID}">Edit /</a>
          <a href="<%=request.getContextPath()%>/AreaController?flag=delete&areaID=${c.areaID}">Delete</a></td>
