                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-6">
                                            ...
                                            <h4 class="header-title m-t-0">Manage City</h4>
                                            ...
                                            <div class="p-20">
                                                <form action="<%=request.getContextPath()%>/CityController" method="post">
													...
													<select class="form-control" name="stateID">
															<f:forEach items="${sessionScope.list1}" var="c">
                                                    ...
                                                    <div class="form-group">
                                                      ...
                                                      <f:forEach items="${sessionScope.editlist}" var="m">
                                                        <input type="hidden" name="cityID" value="${m.cityID}">
                                                     
                                                        <input type="text" name="cityName" parsley-trigger="change" required
                                                               placeholder="Enter City" class="form-control" value="${m.cityName}"><br/>
