                                ...
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 col-md-6">
                                            ...
                                            <h4 class="header-title m-t-0">Manage Area</h4>
                                            ...
                                            <div class="p-20">
                                                 ...
                                                 <form action="<%=request.getContextPath()%>/AreaController" method="post">
                                                  ...
                                                  div class="form-group">
													...
													<select id="state" class="form-control" name="stateID" onchange="loadCity()">
														<f:forEach items="${sessionScope.slist}" var="s" >
                                                    ...
                                                    <f:forEach items="${sessionScope.editlist}" var="c">
                                                     
                                                    <div class="form-group">
                                                    
                                                    
                                                    <input type="hidden" name="areaID" value="${c.areaID}"/>
                                                    
                                                    
                                                        <label for="CityName">Area Name<span class="text-danger">*</span></label>
                                                        
                                                     <input type="text" name="areaName" parsley-trigger="change" required
                                                      placeholder="Enter Area" class="form-control" id="AreaName" value="${c.areaName}"><br/>
                                                    
                                                         </div>
                                                    <div class="form-group">
                                                        <label for="Area Discription">Area discription<span class="text-danger">*</span></label>
                                                        <textarea rows="5" cols="10" parsley-trigger="change" required
                                                               placeholder="Enter Discription" class="form-control" id="AreaDiscription" name="areaDes" >
                                                               
                                                               <f:out value="${c.areaDes}"></f:out>
