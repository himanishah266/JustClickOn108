                                               ...
                                               <input type="hidden" name="flag" value="update"/>
                                                ...
                                                <div class="p-20">
													...
													<select id="city" class="form-control" name="cityID" onchange="loadArea()">
														...
														<f:forEach items="${sessionScope.clist}" var="c" >
													...
													<select id="area11" class="form-control" name="areaID">
                                                     ...
                                                     <input  type="hidden" value="${i.ambulanceNumber}" name="ambulanceNumber">
                                                    
                                                    
                                                    <div class="form-group">
                                                        <label for="Model">Model Number<span class="text-danger">*</span></label>
                                                        <input type="text" parsley-trigger="change" required
                                                               placeholder="Enter Number" class="form-control" value="${i.modelNumber}" id="ModelNumber" name="modelNumber">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="StateName">Passing Year<span class="text-danger">*</span></label>
                                                        <input type="text" name="passingYear" value="${i.passingYear}" parsley-trigger="change" required
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="allocation" value="${i.allocation}" parsley-trigger="change" required
                                                     ...
                                                     <div class="form-group">
                                                        ...
                                                        <input type="text"  parsley-trigger="change" required
                                                               placeholder="Enter Details" class="form-control" id="Allocation" name="latitude" value="${i.latitude}">
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="longitude" parsley-trigger="change" required
                                                               placeholder="Enter Details" class="form-control" id="Allocation" value="${i.longitude}"/>
                                                    </div>
