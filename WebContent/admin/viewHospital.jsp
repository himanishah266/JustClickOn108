                            ...
                            <div class="col-sm-12">
								...
								<input type="hidden" name="flag" value="search">
                                    <table id="datatable" class="table table-striped table-bordered">
										...
										<td><a href="<%=request.getContextPath()%>/HospitalController?flag=edit&hospitalID=${a.hospitalID}">edit</a> </td>
										<td><a href="<%=request.getContextPath()%>/HospitalController?flag=delete&hospitalID=${a.hospitalID}">/delete</a> </td>
										</tr>
										<tr>
										</tr>
