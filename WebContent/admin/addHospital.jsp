...
<script>
				...
				xmlHttp.onreadystatechange = function()
				{
					if(xmlHttp.readyState == 4)
					{
						...
						for(i=0; i<jsonObj.length; i++)
						{
							...
							document.getElementById("area12").options.add(createOption);
						}
					}
				}
	...
	function removeAllarea() {
		var removeState1 = document.getElementById("area12").options.length;

		for (i = removeState1; i >0; i--) {
			document.getElementById("area12").remove(i);
							...
							<div class="card-box">
								...
								<div class="row">
									<div class="col-sm-12 col-xs-12 col-md-6">
										...
										<p class="text-muted font-13 m-b-10">Parsley is a
										...
										<div class="p-20">
											...
											<form
												action="<%=request.getContextPath()%>/HospitalController"
												method="post">
												data-parsley-validate novalidate> <input type="hidden"
													name="flag" value="insert" />
												...
												<div class="p-20">
													...
													<div class="form-group">
														<label for="StateName">State Name<span
															class="text-danger">*</span></label> <select id="state"
															class="form-control" name="stateID" onchange="loadCity()">
													...
													<div class="form-group">
														<label for="CityName">City Name<span
															class="text-danger">*</span></label> <select id="city"
															class="form-control" name="cityID" onchange="loadArea()">
															<option value="">---SELECT---</option>

															<f:forEach items="${sessionScope.citylist}" var="s">
													...
													<div class="form-group">
														<label for="StateName">area Name<span
															class="text-danger">*</span></label> 
															<select id="area12" class="form-control" name="areaID">
													...
													<div class="form-group">
														<label for="Model"> Hospital Name<span
															class="text-danger">*</span></label> <input type="text"
															parsley-trigger="change" required
															placeholder="Enter Name" class="form-control" name="hn">
													</div>
													<div class="form-group">
														<label for="StateName">Hospital descriptionr<span
															class="text-danger">*</span></label> <input type="text" name="hd"
															parsley-trigger="change" required
															placeholder="Enter description" class="form-control">
													</div>
													
													<div class="form-group">
														<label for="StateName">Contact Number<span
															class="text-danger">*</span></label> <input type="text" name="contactNo"
															parsley-trigger="change" required
															placeholder="Enter description" class="form-control">
													</div>
													
													<div class="form-group">
														<label for="StateName">Latitude<span
															class="text-danger">*</span></label> <input type="text" name="latitude"
															parsley-trigger="change" required
															placeholder="Enter description" class="form-control">
													</div>
													
													<div class="form-group">
														<label for="StateName">Longitude<span
															class="text-danger">*</span></label> <input type="text" name="longitude"
															parsley-trigger="change" required
															placeholder="Enter description" class="form-control">
													</div>
