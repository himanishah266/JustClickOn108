                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
									...
									<f:forEach items="${sessionScope.list}" var="i">
                                        ...
                                        <tbody>  
                                            <tr>
                                               ...
                                               <td>${i.stateName}</td>
                                               <td>
                                               				<a href="<%=request.getContextPath()%>/StateController?flag=edit&&stateID=${i.stateID}">Edit /</a>
                                               				<a href="<%=request.getContextPath()%>/StateController?flag=delete&&stateID=${i.stateID}">Delete</a>
                                               </td>
