                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages">
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" action="<%=request.getContextPath()%>/forgetPassword" method="post">
                                  <input type="hidden" name="flag" value="step2">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <input class="form-control" type="password" name="npassword" required="" placeholder=" New Password">
                                            </div>
                                        </div>
                                         <div class="form-group">
                                            <div class="col-xs-12">
