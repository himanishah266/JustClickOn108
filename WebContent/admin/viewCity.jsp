                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">City Table </h4>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                      ...
                                      <f:forEach items="${sessionScope.searchlist}" var="i">
                                      ...
                                      <tr>
	                                      ...
	                                      <a href="<%=request.getContextPath()%>/CityController?flag=edit&cityID=${i.cityID}">Edit /</a>
                                          <a href="<%=request.getContextPath()%>/CityController?flag=delete&cityID=${i.cityID}">Delete</a>
