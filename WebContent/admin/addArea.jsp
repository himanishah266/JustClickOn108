...
<html>
    <head>
        ...
        <!-- App title -->
        <title>Just Click On 108 - Responsive Admin Template</title>
                                            ...
                                            <div class="p-20">
                                                 ...
                                                 <form action="<%=request.getContextPath()%>/AreaController" method="post">
                                                  ...
                                                  <input type="hidden" name="flag" value="insert"/>
													...
													<select class="form-control" id="state" name="stateID" onchange="loadCity()">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="areaName" parsley-trigger="change" required
                                                               placeholder="Enter Area" class="form-control" id="AreaName"><br/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="5" cols="10" parsley-trigger="change" required
                                                               placeholder="Enter Discription" class="form-control" id="AreaDiscription" name="areaDes"></textarea>
                                                                        </div>
